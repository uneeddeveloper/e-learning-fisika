...
import { ssrRenderTeleport, ssrRenderClass, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const __nuxt_page_meta$4 = { layout: "student" };
const __nuxt_page_meta$3 = { layout: "student" };
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./index-DFvXH1Fg.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="dev-badge-wrapper" data-v-fb8a544e><div class="${ssrRenderClass([{ active: unref(isMounted) }, "dev-badge frontend"])}" data-v-fb8a544e><div class="badge-glow frontend-glow" data-v-fb8a544e></div><div class="badge-inner" data-v-fb8a544e><span class="badge-icon" data-v-fb8a544e><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" data-v-fb8a544e><polyline points="16 18 22 12 16 6" data-v-fb8a544e></polyline><polyline points="8 6 2 12 8 18" data-v-fb8a544e></polyline></svg></span><span class="badge-label" data-v-fb8a544e>Frontend</span><span class="badge-dot" data-v-fb8a544e></span></div></div><div class="${ssrRenderClass([{ active: unref(isMounted) }, "dev-badge backend"])}" data-v-fb8a544e><div class="badge-glow backend-glow" data-v-fb8a544e></div><div class="badge-inner" data-v-fb8a544e><span class="badge-icon" data-v-fb8a544e><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" data-v-fb8a544e><rect x="2" y="3" width="20" height="14" rx="2" data-v-fb8a544e></rect><line x1="8" y1="21" x2="16" y2="21" data-v-fb8a544e></line><line x1="12" y1="17" x2="12" y2="21" data-v-fb8a544e></line></svg></span><span class="badge-label" data-v-fb8a544e>Backend</span><span class="badge-dot" data-v-fb8a544e></span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/DevBadge.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-fb8a544e"]]), { __name: "DevBadge" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DevBadge = __nuxt_component_3;
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(isDev)) {
              _push2(ssrRenderComponent(_component_DevBadge, null, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              unref(isDev) ? (openBlock(), createBlock(_component_DevBadge, { key: 0 })) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
...
export { _export_sfc as _, useSupabaseUser as a, useRuntimeConfig as b, asyncDataDefaults as c, createError as d, entry_default as default, useRequestFetch as e, fetchDefaults as f, defineNuxtRouteMiddleware as g, useRouter as h, encodeRoutePath as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
